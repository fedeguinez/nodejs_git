...
We're excited to announce the release of Node.js 20! Highlights include the update of the V8 JavaScript engine to 11.3, a stable test\_runner,
and improved interoperability of WebCryptoAPI.
